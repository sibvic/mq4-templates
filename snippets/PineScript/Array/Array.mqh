...
public:
   ...
   static ITArray<int> *SortIndices(ITArray<string> *arr, string order)
   {
      if (arr == NULL)
      {
   ...
   static ITArray<int> *SortIndices(ITArray<int> *arr, string order)
   {
      if (arr == NULL)
      {
         return new IntArray(0, 0);
   ...
   static ITArray<int> *SortIndices(ISimpleTypeArray<double> *arr, string order)
   {
      if (arr == NULL)
      {
         return new IntArray(0, 0);
   ...
   static string Join(ITArray<string>* array, string concat)
   {
      string res = "";
